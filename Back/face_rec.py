...
class FaceRec:
    ...
    def __init__(self, known_person, unknown_images, known_name=None):
        self.known_person = known_person
        self.unknown_images = unknown_images
    ...
    def recognize_faces(self):
        ...
        for file in os.listdir(self.unknown_images):
            if file[0] != '.':  
                ...
                unknown_image = face_recognition.load_image_file(self.unknown_images + '/' + file)
